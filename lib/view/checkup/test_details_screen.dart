              ...
              children: [
                          ...
                          children: [
                            Padding(
                              ...
                              child: Container(
                                ...
                                child: Center(
                                  child: SvgPicture.asset(AppAssets.vacation,
                            ...
                            Column(
                              ...
                              children: [
                                customText(
                                    ...
                                    fontWeight: FontWeight.w400),
                                customText(
                                    text: "24 Parameters", fontSize: 12.sp),
                              ],
                            )
                          ],
                        ),
                          ...
                          children: [
                            Padding(
                              ...
                              child: Container(
                                ...
                                child: Center(
                                  child: SvgPicture.asset(AppAssets.report,
                                      height: 26.h, width: 22.h),
                                ),
                              ),
                            ),
                            Column(
                ...
                Row(
                  children: [
                    ...
                    SizedBox(width: 20.w),
                    customText(
                        text: "Recommendation for everyone",
                        fontSize: 15.sp,
                        color: kDarkGrey1,
                        fontWeight: FontWeight.w400),
                  ],
                ...
                Padding(
                  ...
                  child:
                      customText(text: "Sample(s) required", fontSize: 15.sp),
                ),
                Row(
                  children: [
          ...
          child: Row(
            children: [
              ...
              CustomButton(
                ...
                onTap: () {
                  Get.toNamed(Routes.labCartPageScreen);
                },
              ),
            ],
          ),
