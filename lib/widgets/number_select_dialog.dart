...
class NumberSelectDialog extends StatelessWidget {
  const NumberSelectDialog({super.key});
                      ...
                      child: Container(
                        ...
                        child: Padding(
                          ...
                          child: Row(
                            children: [
                              controller.numberSelect == index
                                  ? Icon(Icons.check_box, color: kPrimary)
                                  : Icon(Icons.check_box_outline_blank, color: kGrey),
                              SizedBox(width: 10.w),
                              headingText(
                                  text: controller.simInfo.cards[index].phoneNumber ?? '${controller.simInfo.cards[index].displayName}'),
