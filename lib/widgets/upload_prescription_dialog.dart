...
class UploadPrescriptionDialog extends StatefulWidget {
  const UploadPrescriptionDialog({super.key});

  @override
  State<UploadPrescriptionDialog> createState() => _UploadPrescriptionDialogState();
}
