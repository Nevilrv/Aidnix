...
ResGetItemsDetails resGetItemsDetailsFromJson(String str) => ResGetItemsDetails.fromJson(json.decode(str));

String resGetItemsDetailsToJson(ResGetItemsDetails data) => json.encode(data.toJson());

class ResGetItemsDetails {
  bool? status;
  int? code;
  List<LabItems>? data;
  String? message;
  ...
  factory ResGetItemsDetails.fromJson(Map<String, dynamic> json) => ResGetItemsDetails(
        status: json["status"],
        code: json["code"],
        data: json["data"] == null ? [] : List<LabItems>.from(json["data"]!.map((x) => LabItems.fromJson(x))),
...
class LabItems {
  ...
  factory LabItems.fromJson(Map<String, dynamic> json) => LabItems(
