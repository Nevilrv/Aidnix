...
ResGetCategoryDetails resGetCategoryDetailsFromJson(String str) => ResGetCategoryDetails.fromJson(json.decode(str));

String resGetCategoryDetailsToJson(ResGetCategoryDetails data) => json.encode(data.toJson());

class ResGetCategoryDetails {
  bool? status;
  int? code;
  ...
  factory ResGetCategoryDetails.fromJson(Map<String, dynamic> json) => ResGetCategoryDetails(
        status: json["status"],
        code: json["code"],
        data: json["data"] == null ? [] : List<CategoryDetail>.from(json["data"]!.map((x) => CategoryDetail.fromJson(x))),
